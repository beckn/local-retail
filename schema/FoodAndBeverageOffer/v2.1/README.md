...
### Pizza with SIZE and TOPPINGS Customization
```json
{
  "@type": "fnbo:FoodAndBeverageOfferAttributes",
  "customization": {
    "groups": [
      {
        "code": "SIZE",
        ...
        "options": [
          {
            "code": "SMALL",
            "name": "Small (8 inch)",
            "priceDelta": { "type": "FIXED", "value": 0 }
          },
          {
            "code": "MEDIUM",
            "name": "Medium (10 inch)",
            "priceDelta": { "type": "FIXED", "value": 100 }
          },
          {
            "code": "LARGE",
            "name": "Large (12 inch)",
            "priceDelta": { "type": "FIXED", "value": 200 }
          }
        ]
      },
      {
        ...
        "options": [
          {
            "code": "CHEESE",
            "name": "Extra Cheese",
            "priceDelta": { "type": "FIXED", "value": 50 }
          },
          {
            "code": "MUSHROOM",
            "name": "Fresh Mushroom",
            "priceDelta": { "type": "FIXED", "value": 40 },
            "available": true
          },
          {
            "code": "PEPPERONI",
            "name": "Pepperoni",
            "priceDelta": { "type": "FIXED", "value": 60 },
            "available": false
          }
        ]
      }
