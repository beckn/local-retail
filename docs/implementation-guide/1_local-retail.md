          ...
          "items": [
            {
              ...
              "descriptor": {
                "images": [
                  "https://tourism-bpp-infra2.becknprotocol.io/attachments/view/253.jpg"
                ],
  ...
  "message": {
    "order": {
      ...
      "billing": {
        ...
        "address": {
          "door": "123",
          "building": "Terminal 1, Kempegowda Int'l Airport Rd, A - Block, Gangamuthanahalli, Karnataka 560300, India",
          "city": "Gangamuthanahalli",
          "state": "Karnataka",
          "country": "IND",
          "area_code": "75001"
  ...
  "message": {
    "order": {
      ...
      "fulfillment": {
        ...
        "state": {
          "descriptor": {
            "code": "ITEM-GETTING-PACKED",
            "short_desc": "The item is getting packed"
          },
...
```
{
  ...
  "message": {
    "phone": "+11 2222222222",
    "email": "abc.provider@support.com"
  }
}
```